...
void maxSolidCylinder(float base, GLdouble height, GLint slices = 10) {
    ...
    for (int i = 0; i < slices + 1; ++i) {
        ...
        glNormal3f(cos(g * RAD), sin(g * RAD), 0);
        glTexCoord2f(1.0/slices * i, 0 );
        glVertex3f(
                base * cos(g * RAD),
                base * sin(g * RAD),
                0);
        glTexCoord2f(1.0/slices * i, 1 );
        glVertex3f(
                base * cos(g * RAD),
                base * sin(g * RAD),
                height
...
void init(void) {
    ...
    textureManager->CreateTexture("../assets/wood.png", 0);
    textureManager->CreateTexture("../assets/woodtop.png", 1);
}
...
int main(int argc, char **argv) {
    ...
    cout << " * Modifique as texturas pressionando as teclas de um 1 a " << textureManager->GetNumberOfTextures() << ";"
         << endl;
